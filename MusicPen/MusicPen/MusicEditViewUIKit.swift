...
struct MusicEditViewUIKit: View {
...
//Preview
struct MusicEditViewUIKit_Previews: PreviewProvider {
    static var previews: some View {
        MusicEditViewUIKit(MusicTitle: .constant("Sample Music Title"), MusicBar: .constant(1))
    }
}
